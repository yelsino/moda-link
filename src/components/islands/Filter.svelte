<script>
  ...
  const filters = [
    ...
    },
    {
      ...
      ></path><path d="M10.5 11h2.5l-1.5 5"></path></svg
    >`,
    },
    {
      id: "4",
      ...
      width="25px"
      xmlns="http://www.w3.org/2000/svg"
      ><path stroke="none" d="M0 0h24v24H0z" fill="none" stroke-width="1"></path><path
...
<div
  class="hidden sm:flex flex-col fixed z-30 bg-gray-50 left-0 top-1/2 transform -translate-y-1/2"
>
